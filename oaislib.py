...
## oaislib.get_6_date_str() # 6자리 날짜 스트링 리턴
...
def get_6_date_str():
    ...
    year_str = '{0.year}'.format(now_time)
    year_str = year_str[2:4]
    month_str = '{0.month:02}'.format(now_time)
    day_str = '{0.day:02}'.format(now_time)
...
#
#
#def gdf_trans_coor(gdf, old_epsg, new_epsg):
